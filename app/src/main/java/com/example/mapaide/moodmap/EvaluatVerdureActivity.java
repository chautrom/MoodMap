...
public class EvaluatVerdureActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evaluat_verdure);

        ImageView fc1 = (ImageView) findViewById(R.id.face1);
        ImageView fc2 = (ImageView) findViewById(R.id.face2);
        ImageView fc3 = (ImageView) findViewById(R.id.face3);
        ImageView fc4 = (ImageView) findViewById(R.id.face4);
        ImageView fc5 = (ImageView) findViewById(R.id.face5);
